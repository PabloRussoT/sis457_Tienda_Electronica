...
('Accesorios', 'Diversos accesorios para dispositivos electrónicos', 1),
('Hogar Inteligente', 'Dispositivos para automatización del hogar', 1);

INSERT INTO Marca (nombre, descripcion, estado) VALUES
('Samsung', 'Marca surcoreana líder en electrónica', 1),
('Apple', 'Empresa estadounidense de tecnología', 1),
('Sony', 'Conglomerado multinacional japonés de electrónica', 1),
('Xiaomi', 'Empresa china de electrónica y software', 1),
('Logitech', 'Fabricante suizo de periféricos de ordenador', 1);
...
(4, 5, 'MOUSE-MXM-004', 'Mouse Inalámbrico Logitech MX Master 3S', 'Unidad', 100, 99.99, 'AdminUser', 1),
(1, 3, 'AUD-WH1000XM5', 'Auriculares Sony WH-1000XM5 Cancelación de Ruido', 'Unidad', 25, 349.00, 'AdminUser', 1);
